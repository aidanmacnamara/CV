...
\includegraphics[scale=0.4]{signature_aidan.png}
...
\title{\it Senior Data Scientist} \dates{Feb 2020 -- present}
\location{Bayer AG, Wuppertal}
\begin{position}
Acute Care Contact for Biomedical Data Science
\end{position}

\title{\it Computational Biologist} \dates{Jan 2015 -- Feb 2020}
